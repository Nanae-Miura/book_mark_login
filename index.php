...
<!-- 全体のフロー -->
<!-- ログインしなくて使える -->
<!-- index.phpからinsert.phpで情報をデータベースに格納 -->
<!-- main.phpにリダイレクトされる -->
<!-- ログインしなくても使える -->
...
<!-- detail.phpに入力したデータがupdate.phpによって処理されて、index.phpに戻る -->
   ...
   <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="show.php">データ一覧</a></div>
